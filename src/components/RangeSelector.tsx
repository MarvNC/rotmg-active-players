...
export function RangeSelector({ active, onSelect }: RangeSelectorProps) {
  return (
    <div className="inline-flex gap-2 p-1 border border-[var(--color-surface-2)] rounded-full bg-[var(--color-panel-highlight)]" role="group" aria-label="Date range presets">
